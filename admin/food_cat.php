...
<div class="content">
	...
	<table border=0 align="center" background-color="white" width="40%" style="box-shadow: 1px 3px 8px 2px;" cellpadding="10" cellspacing="15" >
	<tr align="center">
   ...
   <tr align="center" >   
   	    <td> 
   	    	<select class="text" name="cat" background-color= "grey">
			   <option value="soup dishes">main dishes</option>
